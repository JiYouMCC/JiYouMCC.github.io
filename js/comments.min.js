...
var o=n.val(),t={}
for(commentId in o){for(var m=o[commentId],a=m.post.split("/"),r=0;r<a.length;){var l=a[r]
""==l?a.splice(r,1):r++}for(var s=t,r=0;r<a.length;r++){var l=a[r].toString()
s[l]||(s[l]={}),s=s[l]}s.count?s.count=s.count+1:s.count=1}Comments._sync.ref("/posts").set(t,function(n){n?(Comments.handleError(n),Comments.handleCallback(e,!1)):Comments.handleCallback(e,!0)})})}}}}
