...
顺手撸的代码在： [jekyll-firebase-comments](https://github.com/JiYouMCC/jekyll-firebase-comments){:target="_blank"}
...
具体怎么用我在 [Demo Page](http://www.jithee.name/jekyll-firebase-comments/){:target="_blank"} 里面已经写了2个，当然比较粗糙了
...
<textarea class="form-control" id="source_json"></textarea>
...
<textarea class="form-control" id="result_json" disabled></textarea>
